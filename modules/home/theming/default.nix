...
let
  ...
  # ships.
  #
  # Referenced via the flake's own packages output, NOT
  # pkgs.keystone-desktop.*: only nixosModules.default applies
  # self.overlays.default, so standalone Home Manager consumers of
  # homeModules.default have no keystone-desktop attr in pkgs.
  writePolkitThemeBin = "${
